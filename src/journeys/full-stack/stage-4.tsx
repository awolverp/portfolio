...
export function BuildBackendFrontendStage() {
  return (
    <Stage.Root>
      ...
      <Stage.Layer position="bottom" className="flex w-full items-start justify-center px-4 mt-10">
        <BuildFlow />
      </Stage.Layer>
    </Stage.Root>
  );
...
function FlowArrow({ line, head, delay }: { line: string; head: string; delay: number }) {
  return (
