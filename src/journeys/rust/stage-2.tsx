import { DatabaseIcon, FileTextIcon, type LucideIcon, Share2Icon } from "lucide-react";
...
export function ModelWithTypesStage() {
  return (
    <Stage.Root>
      ...
      <Stage.Layer position="bottom" className="flex flex-col items-center justify-start">
        <ModelingTree />
      </Stage.Layer>
    </Stage.Root>
  );
  ...
  return (
    <div className={nodeStyle}>
      ...
      <span className="text-left leading-tight">
        ...
        <span className="hidden font-light text-xs md:text-sm lg:block">Data Modeling</span>
      </span>
    </div>
  );
}
